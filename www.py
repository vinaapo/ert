...
fon = transform.scale(image.load('fon1.JPG'), (600,600))
...
while game:
    ...
    if hp < 1:
        game = False
    if points == 9:  #нач
        textitog1 = wr.render(str(itog1), True, (0,0,0))
        okno.blit(textitog1, (210,250))
    display.update()
    clock.tick(60)
